...
config_file = []
config_file.append(
    os.path.join("work_dir", "segresnet_0", "configs", "hyper_parameters.yaml")
)
config_file.append(os.path.join("work_dir", "segresnet_0", "configs", "network.yaml"))
config_file.append(
    os.path.join("work_dir", "segresnet_0", "configs", "transforms_train.yaml")
)
config_file.append(
    os.path.join("work_dir", "segresnet_0", "configs", "transforms_validate.yaml")
)
...
from work_dir.segresnet_0.scripts import loss
loss_function = loss.DiceCELoss2()
...
num_sw_batch_size = int(sys.argv[2])

validation_data_device = str(sys.argv[3]).lower()
