...
def auto_adjust_network_settings(
    ...
    if auto_scale_batch and roi_size.prod() < base_numel*gpu_factor_init:
        ...
        if global_rank==0:
            print(f"increased batch_size {batch_size} base_numel {base_numel},  gpu_factor {gpu_factor},  gpu_factor_init {gpu_factor_init}")
    ...
    if global_rank==0:
        print(f"Suggested network parameters: \n"
