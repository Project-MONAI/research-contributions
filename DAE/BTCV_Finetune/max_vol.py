...
# from unetr_og_change import UNETR as UNETR_c
...
def main_worker(gpu, args):
    ...
    if args.model_name == "swin":
    ...
    elif args.model_name == "unetr_change":
        model = UNETR_c(
            in_channels=args.in_channels,
            out_channels=args.out_channels,
            img_size=(args.roi_x, args.roi_y, args.roi_z),
    ...
    elif args.model_name == "unetr_tok":
        model = UNETR_tok(
            in_channels=args.in_channels,
            out_channels=args.out_channels,
            img_size=(args.roi_x, args.roi_y, args.roi_z),
        ...
        model = UNETR_patch(
            ...
            res_block=True,
            dropout_rate=args.dropout_rate,
            patch_merge_layer_index=args.patch_merge_layer_index,
            patch_merge_num_tokens=args.patch_merge_num_tokens,
        )
    elif args.model_name == "unetr_patch_8":
        model = UNETR_patch_8(
            in_channels=args.in_channels,
            out_channels=args.out_channels,
            img_size=(args.roi_x, args.roi_y, args.roi_z),
    ...
    elif args.model_name == "unetr_fuse":
        model = UNETR_fuse(
            in_channels=args.in_channels,
            out_channels=args.out_channels,
            img_size=(args.roi_x, args.roi_y, args.roi_z),
    ...
    # pdb.set_trace()
    input = torch.randn(4, 1, args.roi_x, args.roi_y, args.roi_z)
    ans = model(input)
    import os
    ...
    print("FLOPS", float(flops.total() / 1000000000))
