    ...
    if args.test_mode:
        ...
        if args.use_normal_dataset:
            ...
            val_ds = data.CacheDataset(
                data=val_files, transform=train_transform, cache_rate=1.0, num_workers=args.workers
            )
        ...
        val_loader = data.DataLoader(
            val_ds, batch_size=2, shuffle=False, num_workers=args.workers, sampler=val_sampler, pin_memory=True
        )
